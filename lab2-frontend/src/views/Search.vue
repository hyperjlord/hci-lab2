    ...
    <el-container>
      <el-header>
        <div style="color: gold">
          ...
          Image Search
          <el-button v-on:click="showFavorites" style="float: right;margin-top: 12px" type="success" plain>查看收藏夹</el-button>
        </div>
      </el-header>
      <el-main>
        <el-card class="box-card">
          <el-upload
              ...
              :file-list="fileList"
              list-type="picture">
            <el-button size="small" type="primary">点击上传图片搜索 <i class="el-icon-upload"></i></el-button>
            ...
            <el-col :span="8" v-for="item in favorites" :key="item">
              <el-card :body-style="{ padding: '8px',}">
                ...
                <div style="padding: 14px;">
                  ...
                  <div class="bottom clearfix">
                    <time class="time">{{item.slice(item.indexOf('im'))}}</time>
                    <el-button type="warning"  v-on:click="handleFavorites(item)" class="button" icon="el-icon-delete" circle></el-button>
                  </div>
                </div>
              </el-card>
            </el-col>
  ...
  methods: {
    ...
    handleSuccess(response, file, fileList) {
      ...
      for (let i = 0; i < this.imageList.length; i++) {
        this.imageList[i]="http://47.115.33.176:5000"+this.imageList[i].replace("\\","/");
      }
